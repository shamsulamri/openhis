    ...
    <div class='form-group  @if ($errors->has('triage_name')) has-error @endif'>
        <label for='triage_name' class='col-sm-2 control-label'>triage_name<span style='color:red;'> *</span></label>
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('triage_color')) has-error @endif'>
        <label for='triage_color' class='col-sm-2 control-label'>triage_color<span style='color:red;'> *</span></label>
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('triage_position')) has-error @endif'>
        {{ Form::label('triage_position', 'triage_position',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
