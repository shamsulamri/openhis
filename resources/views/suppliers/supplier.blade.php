    ...
    <div class='form-group  @if ($errors->has('supplier_name')) has-error @endif'>
        <label for='supplier_name' class='col-sm-2 control-label'>Name<span style='color:red;'> *</span></label>
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('supplier_street_1')) has-error @endif'>
        {{ Form::label('supplier_street_1', 'Street 1',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('supplier_street_2')) has-error @endif'>
        {{ Form::label('supplier_street_2', 'Street 2',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
	...
	<!--
    <div class='form-group  @if ($errors->has('supplier_city')) has-error @endif'>
        {{ Form::label('supplier_city', 'City',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('supplier_postcode')) has-error @endif'>
        {{ Form::label('supplier_postcode', 'Postcode',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('supplier_state')) has-error @endif'>
        {{ Form::label('supplier_state', 'State',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('supplier_country')) has-error @endif'>
        {{ Form::label('supplier_country', 'Country',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('supplier_phone')) has-error @endif'>
        {{ Form::label('supplier_phone', 'Phone',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('supplier_person')) has-error @endif'>
        {{ Form::label('supplier_person', 'Contact Person',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('supplier_account')) has-error @endif'>
        {{ Form::label('supplier_account', 'Supplier Account',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
