    ...
    <div class='form-group  @if ($errors->has('waste_date')) has-error @endif'>
        <label for='waste_date' class='col-sm-3 control-label'>waste_date<span style='color:red;'> *</span></label>
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('period_code')) has-error @endif'>
        {{ Form::label('period_code', 'period_code',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('waste_unit')) has-error @endif'>
        <label for='waste_unit' class='col-sm-3 control-label'>waste_unit<span style='color:red;'> *</span></label>
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('waste_note')) has-error @endif'>
        {{ Form::label('waste_note', 'waste_note',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
