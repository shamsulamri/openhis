...
{{ Form::model($medication_record, ['route'=>['medication_records.update',$medication_record->medication_id],'method'=>'PUT', 'class'=>'form-horizontal']) }} 
    ...
    <div class='form-group  @if ($errors->has('medication_datetime')) has-error @endif'>
        <label for='medication_datetime' class='col-sm-2 control-label'>Current Datetime</label>
        <div class='col-sm-10'>
	...
	<div class="row">
			<div class="col-xs-6">
					<div class='form-group  @if ($errors->has('medication_date')) has-error @endif'>
						{{ Form::label('Date', 'New Date',['class'=>'col-md-4 control-label']) }}
						<div class='col-md-8'>
			...
			<div class="col-xs-6">
					<div class='form-group  @if ($errors->has('medication_time')) has-error @endif'>
						{{ Form::label('Time', 'New Time',['class'=>'col-md-4 control-label']) }}
						<div class='col-md-8'>
    ...
    <div class='form-group'>
        <div class="col-sm-offset-2 col-sm-10">
            <a class="btn btn-default" href="/medication_record/mar/{{ $medication_record->order->encounter_id }}" role="button">Cancel</a>
