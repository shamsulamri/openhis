...
<br>
   ...
   <div class='form-group  @if ($errors->has('delivery_code')) has-error @endif'>
        {{ Form::label('delivery_code', 'delivery_code',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('newborn_weight')) has-error @endif'>
        {{ Form::label('newborn_weight', 'newborn_weight',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('newborn_length')) has-error @endif'>
        {{ Form::label('newborn_length', 'newborn_length',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('newborn_head_circumferance')) has-error @endif'>
        {{ Form::label('newborn_head_circumferance', 'newborn_head_circumferance',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('newborn_g6pd')) has-error @endif'>
        {{ Form::label('newborn_g6pd', 'newborn_g6pd',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('newborn_hepatitis_b')) has-error @endif'>
        {{ Form::label('newborn_hepatitis_b', 'newborn_hepatitis_b',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('newborn_bcg')) has-error @endif'>
        {{ Form::label('newborn_bcg', 'newborn_bcg',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('newborn_vitamin_k')) has-error @endif'>
        {{ Form::label('newborn_vitamin_k', 'newborn_vitamin_k',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('newborn_apgar')) has-error @endif'>
        {{ Form::label('newborn_apgar', 'newborn_apgar',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('newborn_term')) has-error @endif'>
        {{ Form::label('newborn_term', 'newborn_term',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('newborn_thyroid')) has-error @endif'>
        {{ Form::label('newborn_thyroid', 'newborn_thyroid',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('apgar_heart_rate')) has-error @endif'>
        {{ Form::label('apgar_heart_rate', 'apgar_heart_rate',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('apgar_breathing')) has-error @endif'>
        {{ Form::label('apgar_breathing', 'apgar_breathing',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('apgar_grimace')) has-error @endif'>
        {{ Form::label('apgar_grimace', 'apgar_grimace',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('apgar_activity')) has-error @endif'>
        {{ Form::label('apgar_activity', 'apgar_activity',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('apgar_appearance')) has-error @endif'>
        {{ Form::label('apgar_appearance', 'apgar_appearance',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('newborn_gestational_weeks')) has-error @endif'>
        {{ Form::label('newborn_gestational_weeks', 'newborn_gestational_weeks',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('newborn_gestational_days')) has-error @endif'>
        {{ Form::label('newborn_gestational_days', 'newborn_gestational_days',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('complication_code')) has-error @endif'>
        {{ Form::label('complication_code', 'complication_code',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('birth_code')) has-error @endif'>
        {{ Form::label('birth_code', 'birth_code',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
