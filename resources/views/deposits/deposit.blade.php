    ...
    <div class='form-group  @if ($errors->has('deposit_amount')) has-error @endif'>
        <label for='deposit_amount' class='col-sm-2 control-label'>Amount<span style='color:red;'> *</span></label>
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('payment_code')) has-error @endif'>
        <label for='payment_code' class='col-sm-2 control-label'>Payment Method<span style='color:red;'> *</span></label>
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('deposit_description')) has-error @endif'>
        {{ Form::label('deposit_description', 'Note',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
