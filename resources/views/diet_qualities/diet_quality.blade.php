    ...
    <div class='form-group  @if ($errors->has('qc_date')) has-error @endif'>
        <label for='qc_date' class='col-sm-3 control-label'>qc_date<span style='color:red;'> *</span></label>
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('period_code')) has-error @endif'>
        <label for='period_code' class='col-sm-3 control-label'>period_code<span style='color:red;'> *</span></label>
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('qc_texture')) has-error @endif'>
        {{ Form::label('qc_texture', 'qc_texture',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('qc_texture_note')) has-error @endif'>
        {{ Form::label('qc_texture_note', 'qc_texture_note',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('qc_taste')) has-error @endif'>
        {{ Form::label('qc_taste', 'qc_taste',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('qc_taste_note')) has-error @endif'>
        {{ Form::label('qc_taste_note', 'qc_taste_note',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('qc_aroma')) has-error @endif'>
        {{ Form::label('qc_aroma', 'qc_aroma',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('qc_aroma_note')) has-error @endif'>
        {{ Form::label('qc_aroma_note', 'qc_aroma_note',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('qc_color')) has-error @endif'>
        {{ Form::label('qc_color', 'qc_color',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('qc_color_note')) has-error @endif'>
        {{ Form::label('qc_color_note', 'qc_color_note',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('qc_size')) has-error @endif'>
        {{ Form::label('qc_size', 'qc_size',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('qc_size_note')) has-error @endif'>
        {{ Form::label('qc_size_note', 'qc_size_note',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('qc_comments')) has-error @endif'>
        {{ Form::label('qc_comments', 'qc_comments',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('qc_suggestion')) has-error @endif'>
        {{ Form::label('qc_suggestion', 'qc_suggestion',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
