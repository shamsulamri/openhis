	...
	<div class="row">
			<div class="col-xs-6">
					<div class='form-group  @if ($errors->has('drug_strength')) has-error @endif'>
						{{ Form::label('drug_strength', 'drug_strength',['class'=>'col-md-4 control-label']) }}
						<div class='col-md-8'>
	...
	<div class="row">
			<div class="col-xs-6">
					<div class='form-group  @if ($errors->has('drug_dosage')) has-error @endif'>
						{{ Form::label('drug_dosage', 'drug_dosage',['class'=>'col-md-4 control-label']) }}
						<div class='col-md-8'>
	...
	<div class="row">
			<div class="col-xs-6">
					<div class='form-group  @if ($errors->has('drug_period')) has-error @endif'>
						{{ Form::label('drug_period', 'drug_period',['class'=>'col-md-4 control-label']) }}
						<div class='col-md-8'>
