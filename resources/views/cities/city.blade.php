    ...
    <div class='form-group  @if ($errors->has('city_name')) has-error @endif'>
        <label for='city_name' class='col-sm-3 control-label'>city_name<span style='color:red;'> *</span></label>
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('state_code')) has-error @endif'>
        {{ Form::label('state_code', 'state_code',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
