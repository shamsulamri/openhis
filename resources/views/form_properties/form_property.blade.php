    ...
    <div class='form-group  @if ($errors->has('property_name')) has-error @endif'>
        <label for='property_name' class='col-sm-3 control-label'>property_name<span style='color:red;'> *</span></label>
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('property_type')) has-error @endif'>
        <label for='property_type' class='col-sm-3 control-label'>property_type<span style='color:red;'> *</span></label>
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('property_unit')) has-error @endif'>
        {{ Form::label('property_unit', 'property_unit',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('property_limit_1')) has-error @endif'>
        {{ Form::label('property_limit_1', 'property_limit_1',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('property_limit_2')) has-error @endif'>
        {{ Form::label('property_limit_2', 'property_limit_2',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('property_limit_type')) has-error @endif'>
        {{ Form::label('property_limit_type', 'property_limit_type',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('property_list')) has-error @endif'>
        {{ Form::label('property_list', 'property_list',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('property_shortname')) has-error @endif'>
        {{ Form::label('property_shortname', 'property_shortname',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('property_system')) has-error @endif'>
        {{ Form::label('property_system', 'property_system',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('property_multiline')) has-error @endif'>
        {{ Form::label('property_multiline', 'property_multiline',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
