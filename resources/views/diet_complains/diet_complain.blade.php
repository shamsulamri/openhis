    ...
    <div class='form-group  @if ($errors->has('complain_date')) has-error @endif'>
        <label for='complain_date' class='col-sm-3 control-label'>complain_date<span style='color:red;'> *</span></label>
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('meal_code')) has-error @endif'>
        <label for='meal_code' class='col-sm-3 control-label'>meal_code<span style='color:red;'> *</span></label>
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('contaminate_meal_other')) has-error @endif'>
        {{ Form::label('contaminate_meal_other', 'contaminate_meal_other',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('complain_contaminate_other')) has-error @endif'>
        {{ Form::label('complain_contaminate_other', 'complain_contaminate_other',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('complain_other')) has-error @endif'>
        {{ Form::label('complain_other', 'complain_other',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('patient_mrn')) has-error @endif'>
        {{ Form::label('patient_mrn', 'patient_mrn',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('complain_reported')) has-error @endif'>
        {{ Form::label('complain_reported', 'complain_reported',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('complain_action')) has-error @endif'>
        {{ Form::label('complain_action', 'complain_action',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
