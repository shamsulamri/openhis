    ...
    <div class='form-group  @if ($errors->has('route_name')) has-error @endif'>
        <label for='route_name' class='col-sm-2 control-label'>route_name<span style='color:red;'> *</span></label>
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('route_label')) has-error @endif'>
        {{ Form::label('route_label', 'route_label',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
