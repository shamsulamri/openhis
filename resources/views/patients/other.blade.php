...
{{ Form::model($patient, ['route'=>['patients.update',$patient->patient_id,'tab=contact'],'method'=>'PUT', 'class'=>'form-horizontal']) }} 
    <div class='form-group  @if ($errors->has('patient_is_pati')) has-error @endif'>
        {{ Form::label('Illegal Immigrant', 'Illegal Immigrant',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('patient_is_royal')) has-error @endif'>
        {{ Form::label('Royalty', 'Royalty',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('patient_is_vip')) has-error @endif'>
        {{ Form::label('VIP', 'VIP',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
	...
	<div class='form-group  @if ($errors->has('patient_related_mrn')) has-error @endif'>
        {{ Form::label('Related MRN', 'Related MRN',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
	...
	<div class='form-group  @if ($errors->has('patient_gravida')) has-error @endif'>
        {{ Form::label('Gravida', 'Gravida',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
	...
	<div class='form-group  @if ($errors->has('patient_parity')) has-error @endif'>
        {{ Form::label('Parity', 'Parity',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
	...
	<div class='form-group  @if ($errors->has('patient_parity_plus')) has-error @endif'>
        {{ Form::label('Parity Plus', 'Parity Plus',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
	...
	<div class='form-group  @if ($errors->has('patient_lnmp')) has-error @endif'>
        {{ Form::label('Last Normal Menstrul Date', 'Last Normal Menstrul Date',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
