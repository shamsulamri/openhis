...
<div class="tabs-container">
		<ul class="nav nav-tabs">
				...
				<li class=""><a data-toggle="tab" href="#tab-2">Identification</a></li>
				<li class=""><a data-toggle="tab" href="#tab-3">Address</a></li>
				<li class=""><a data-toggle="tab" href="#tab-4">Contact</a></li>
		</ul>
			...
			<div id="tab-2" class="tab-pane">
				<div class="panel-body">
					...
					<div class="row">
							<div class="col-xs-6">
									<div class='form-group  @if ($errors->has('patient_new_ic')) has-error @endif'>
										{{ Form::label('New Identification', 'New Identification',['class'=>'col-md-5 control-label']) }}
										<div class='col-md-7'>
							...
							<div class="col-xs-6">
									<div class='form-group  @if ($errors->has('patient_old_ic')) has-error @endif'>
										{{ Form::label('Old Identification', 'Old Identification',['class'=>'col-md-5 control-label']) }}
										<div class='col-md-7'>
				 ...
				 <div class='form-group  @if ($errors->has('patient_birth_certificate')) has-error @endif'>
						{{ Form::label('Birth Certificate', 'Birth Certificate',['class'=>'col-md-5 control-label']) }}
						<div class='col-md-7'>
					   ...
					   <div class='form-group  @if ($errors->has('patient_passport')) has-error @endif'>
						{{ Form::label('Passport', 'Passport',['class'=>'col-md-5 control-label']) }}
						<div class='col-md-7'>
					...
					<div class="row">
							<div class="col-xs-6">
									<div class='form-group  @if ($errors->has('patient_military_id')) has-error @endif'>
										{{ Form::label('Military ID', 'Military ID',['class'=>'col-md-5 control-label']) }}
										<div class='col-md-7'>
							...
							<div class="col-xs-6">
									<div class='form-group  @if ($errors->has('patient_police_id')) has-error @endif'>
										{{ Form::label('Police ID', 'Police ID',['class'=>'col-md-5 control-label']) }}
										<div class='col-md-7'>
					...
					<div class="row">
							...
							<div class="col-xs-6">
								<div class='form-group  @if ($errors->has('patient_cur_postcode')) has-error @endif'>
										...
										<div class='col-md-8'>
											{{ Form::text('patient_cur_postcode', null, ['class'=>'form-control','data-mask'=>'99999','placeholder'=>'','maxlength'=>'5']) }}
					...
					<div class="row">
							...
							<div class="col-xs-6">
									<div class='form-group  @if ($errors->has('patient_per_postcode')) has-error @endif'>
										{{ Form::label('Postcode', 'Postcode',['class'=>'col-md-4 control-label']) }}
										<div class='col-md-8'>
											{{ Form::text('patient_per_postcode', null, ['class'=>'form-control','data-mask'=>'99999','placeholder'=>'','maxlength'=>'5']) }}
