...
<h4>
		...
		<br><br>
		<span class='fa fa-file-o' aria-hidden='true'></span>
		<a target="_blank" href="{{ Config::get('host.report_server') }}?report=patient_lab&id={{ $patient->patient_id }}">
...
@if ($patient->activeEncounter()) 
		<br><br>
		<span class='fa fa-file-o' aria-hidden='true'></span>
		<a target="_blank" href="{{ Config::get('host.report_server') }}?report=wrist_label&id={{ $patient->activeEncounter()->encounter_id }}">
		Patient Wrist Label
		</a>
		...
		<br><br>
		<span class='fa fa-file-o' aria-hidden='true'></span>
		<a target="_blank" href="{{ Config::get('host.report_server') }}?report=wrist_newborn_patient&id={{ $patient->activeEncounter()->encounter_id }}">
...
@endif
		<br><br>
		<span class='fa fa-file-o' aria-hidden='true'></span>
		<a target="_blank" href="{{ Config::get('host.report_server') }}?report=patient_detail&id={{ $patient->patient_id }}">
		Patient Demography	
		</a>
