    ...
    <div class='form-group  @if ($errors->has('room_code')) has-error @endif'>
        {{ Form::label('room_code', 'room_code',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('bed_name')) has-error @endif'>
        <label for='bed_name' class='col-sm-2 control-label'>bed_name<span style='color:red;'> *</span></label>
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('bed_virtual')) has-error @endif'>
        {{ Form::label('bed_virtual', 'bed_virtual',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
