    ...
    <div class='form-group  @if ($errors->has('frequency_name')) has-error @endif'>
        <label for='frequency_name' class='col-sm-3 control-label'>frequency_name<span style='color:red;'> *</span></label>
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('frequency_label')) has-error @endif'>
        {{ Form::label('frequency_label', 'frequency_label',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('frequency_value')) has-error @endif'>
        {{ Form::label('frequency_value', 'frequency_value',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
