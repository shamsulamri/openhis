    ...
    <div class='form-group'>
        <label for='order' class='col-sm-2 control-label'>Product</span></label>
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('cancel_reason')) has-error @endif'>
        <label for='cancel_reason' class='col-sm-2 control-label'>Reason<span style='color:red;'> *</span></label>
        <div class='col-sm-10'>
    ...
    <div class='form-group'>
        <div class="col-sm-offset-2 col-sm-10">
            <a class="btn btn-default" href="/order_tasks/task/{{ $task_cancellation->order->consultation->consultation_id }}/{{ $task_cancellation->order->product->category->location_code }}" role="button">Cancel</a>
