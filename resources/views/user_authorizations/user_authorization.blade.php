    ...
    <div class='form-group  @if ($errors->has('system_administrator')) has-error @endif'>
        <label for='system_administrator' class='col-sm-3 control-label'>System Administrator</label>
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('author_name')) has-error @endif'>
        <label for='author_name' class='col-sm-3 control-label'>Name<span style='color:red;'> *</span></label>
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('module_patient')) has-error @endif'>
        <label for='module_patient' class='col-sm-3 control-label'>Patient Module</label>
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('module_consultation')) has-error @endif'>
        <label for='module_consultation' class='col-sm-3 control-label'>Consultation Module</label>
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('appointment_function')) has-error @endif'>
        <label for='appointment_function' class='col-sm-3 control-label'>Appointment Module</label>
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('module_inventory')) has-error @endif'>
        <label for='module_inventory' class='col-sm-3 control-label'>Inventory Module</label>
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('module_ward')) has-error @endif'>
        <label for='module_ward' class='col-sm-3 control-label'>Ward Module</label>
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('module_discharge')) has-error @endif'>
        <label for='module_discharge' class='col-sm-3 control-label'>Financial Module</label>
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('module_diet')) has-error @endif'>
        <label for='module_diet' class='col-sm-3 control-label'>Kitchen & Dietary Module</label>
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('module_medical_record')) has-error @endif'>
        <label for='module_medical_record' class='col-sm-3 control-label'>Medical Record Module</label>
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('module_support')) has-error @endif'>
        <label for='module_support' class='col-sm-3 control-label'>Supporting Module</label>
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('patient_list')) has-error @endif'>
        <label for='patient_list' class='col-sm-3 control-label'>Patient List</label>
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('product_list')) has-error @endif'>
        <label for='product_list' class='col-sm-3 control-label'>Product List</label>
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('loan_function')) has-error @endif'>
        <label for='loan_function' class='col-sm-3 control-label'>Loan Function</label>
        <div class='col-sm-9'>
