    ...
    <div class='form-group  @if ($errors->has('property_code')) has-error @endif'>
        <label for='property_code' class='col-sm-3 control-label'>property_code<span style='color:red;'> *</span></label>
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('property_position')) has-error @endif'>
        {{ Form::label('property_position', 'property_position',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
