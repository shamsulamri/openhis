    ...
    <div class='form-group  @if ($errors->has('category_code')) has-error @endif'>
        {{ Form::label('category_code', 'category_code',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('drug_trade_name')) has-error @endif'>
        {{ Form::label('drug_trade_name', 'drug_trade_name',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('drug_registration_number')) has-error @endif'>
        {{ Form::label('drug_registration_number', 'drug_registration_number',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('drug_unit_charge')) has-error @endif'>
        {{ Form::label('drug_unit_charge', 'drug_unit_charge',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
