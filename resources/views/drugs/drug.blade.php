    ...
    <div class='form-group  @if ($errors->has('drug_generic_name')) has-error @endif'>
        {{ Form::label('drug_generic_name', 'Generic Name',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('drug_label')) has-error @endif'>
        {{ Form::label('drug_label', 'Label',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('active_ingredient')) has-error @endif'>
        {{ Form::label('active_ingredient', 'Active Ingredient',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('drug_category')) has-error @endif'>
        {{ Form::label('drug_category', 'Category',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('drug_schedule')) has-error @endif'>
        {{ Form::label('drug_schedule', 'Schedule',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('drug_formulary')) has-error @endif'>
        {{ Form::label('drug_formulary', 'Formulary',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('drug_type')) has-error @endif'>
        {{ Form::label('drug_type', 'Type',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('item_subgroup')) has-error @endif'>
        {{ Form::label('item_subgroup', 'Subgroup',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('uom_strength')) has-error @endif'>
        {{ Form::label('uom_strength', 'UOM Strength',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('dosage_form')) has-error @endif'>
        {{ Form::label('dosage_form', 'Dosage Form',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('sku_uom')) has-error @endif'>
        {{ Form::label('sku_uom', 'SKU UOM',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
