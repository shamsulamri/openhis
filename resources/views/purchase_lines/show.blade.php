	...
	<div class="row">
			<div class="col-xs-7">
					<div class='form-group'>
						...
						<a class="btn btn-default" href="{{ Config::get('host.report_server') }}/ReportServlet?report={{ $purchase->document_code=='indent_request'?'indent':'purchase' }}&id={{ $purchase->purchase_id }}" role="button" target="_blank">Print</a> 
					</div>
			</div>
			<div class="col-xs-5">
					<div class='form-group'>
