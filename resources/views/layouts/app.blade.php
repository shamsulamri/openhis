            ...
            <ul class="nav metismenu" id="side-menu">
				...
				@cannot('system-administrator')
					...
					@endif
						...
						<li><a title='Block Slot' href="{{ url('/block_dates') }}"><i class="fa fa-th"></i><span class='nav-label'>Block Slot</span></a></li>
						@endcan
						<!-- Consultation Module -->
...
-->
						...
						@can('product_list')
								...
								<li><a title='Purchases' href="{{ url('/purchases') }}"><i class='fa fa-shopping-cart'></i><span class='nav-label'>Purchases</span></a></li>
								<li><a title='Stock Movement' href="{{ url('/inventory_movements') }}"><i class='fa fa-truck'></i><span class='nav-label'>Stock Movements</span></a></li>
								@endcannot
						@endcan
