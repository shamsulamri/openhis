    ...
    <div class='form-group  @if ($errors->has('bill_payment_total')) has-error @endif'>
        <label for='bill_payment_total' class='col-sm-2 control-label'>bill_payment_total<span style='color:red;'> *</span></label>
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('bill_deposit_total')) has-error @endif'>
        <label for='bill_deposit_total' class='col-sm-2 control-label'>bill_deposit_total<span style='color:red;'> *</span></label>
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('bill_outstanding')) has-error @endif'>
        <label for='bill_outstanding' class='col-sm-2 control-label'>bill_outstanding<span style='color:red;'> *</span></label>
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('bill_change')) has-error @endif'>
        <label for='bill_change' class='col-sm-2 control-label'>bill_change<span style='color:red;'> *</span></label>
        <div class='col-sm-10'>
