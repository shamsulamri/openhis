    ...
    <div class='form-group  @if ($errors->has('move_from')) has-error @endif'>
        {{ Form::label('move_from', 'move_from',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('move_to')) has-error @endif'>
        {{ Form::label('move_to', 'move_to',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('move_date')) has-error @endif'>
        <label for='move_date' class='col-sm-2 control-label'>move_date<span style='color:red;'> *</span></label>
        <div class='col-sm-10'>
