    ...
    <div class='form-group  @if ($errors->has('block_name')) has-error @endif'>
        {{ Form::label('block_name', 'block_name',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('block_date')) has-error @endif'>
        <label for='block_date' class='col-sm-2 control-label'>block_date<span style='color:red;'> *</span></label>
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('block_recur_annually')) has-error @endif'>
        {{ Form::label('block_recur_annually', 'block_recur_annually',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('block_recur_weekly')) has-error @endif'>
        {{ Form::label('block_recur_weekly', 'block_recur_weekly',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('block_recur_monthly')) has-error @endif'>
        {{ Form::label('block_recur_monthly', 'block_recur_monthly',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
