    ...
    <div class='form-group  @if ($errors->has('dosage_name')) has-error @endif'>
        <label for='dosage_name' class='col-sm-2 control-label'>dosage_name<span style='color:red;'> *</span></label>
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('dosage_label')) has-error @endif'>
        {{ Form::label('dosage_label', 'dosage_label',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
