	...
	<div class="form-group">
		<div class="dropdown">
				...
				<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
						...
						<li><a href="javascript:loadAnnotation('body_front_f.png')">Body Front </a></li>
						<li><a href="javascript:loadAnnotation('body_back_f.png')">Body Back </a></li>
				</ul>
		</div>
	</div>
	...
	<div class="form-group">
		<div class="dropdown">
				...
				<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
						...
						<li><a href="javascript:loadAnnotation('chest_front_f.png')">Chest Front </a></li>
						<li><a href="javascript:loadAnnotation('chest_heart.png')">Chest Heart</a></li>
						<li><a href="javascript:loadAnnotation('chest_l_side_f.png')">Chest L Side </a></li>
						<li><a href="javascript:loadAnnotation('chest_r_side_f.png')">Chest R Side </a></li>
				</ul>
		</div>
	</div>
	...
	<div class="form-group">
		<div class="dropdown">
				...
				<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
						...
						<li><a href="javascript:loadAnnotation('baby_body_front_f.png')">Baby Back Front </a></li>
				</ul>
		</div>
	</div>
	...
	<div class="form-group">
		<div class="dropdown">
				...
				<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
						<li><a href="javascript:loadAnnotation('child_abdomen_f.png')">Child Abdomen </a></li>
						<li><a href="javascript:loadAnnotation('child_back.png')">Child Back</a></li>
						<li><a href="javascript:loadAnnotation('child_body_front_f.png')">Child Body Front </a></li>
...
<!--
  <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
		...
		<li class="dropdown-submenu">
				<a class="test" tabindex="-1" href="#">Body</a>
		...
		<li class="dropdown-submenu">
				<a class="test" tabindex="-1" href="#">Chest</a>
				<ul class="dropdown-menu">
						<li><a href="javascript:loadAnnotation('chest_back.png')">Chest Back</a></li>
						<li><a href="javascript:loadAnnotation('chest_front_f.png')">Chest Front </a></li>
						<li><a href="javascript:loadAnnotation('chest_heart.png')">Chest Heart</a></li>
		...
		<li class="dropdown-submenu">
				<a class="test" tabindex="-1" href="#">Ear</a>
				<ul class="dropdown-menu">
						<li><a href="javascript:loadAnnotation('r_ear.png')">Right Ear</a></li>
						<li><a href="javascript:loadAnnotation('l_ear.png')">Left Ear</a></li>
						<li><a href="javascript:loadAnnotation('r_tympanic_fembrane.png')">Right Tympanic Membrane</a></li>
		...
		<li class="dropdown-submenu">
				<a class="test" tabindex="-1" href="#">Eye</a>
				<ul class="dropdown-menu">
						<li><a href="javascript:loadAnnotation('eyes.png')">Eyes</a></li>
						<li><a href="javascript:loadAnnotation('r_eye.png')">Right Eye</a></li>
						<li><a href="javascript:loadAnnotation('r_fundus.png')">Right Fundus</a></li>
		...
		<li class="dropdown-submenu">
				<a class="test" tabindex="-1" href="#">Face</a>
				<ul class="dropdown-menu">
						<li><a href="javascript:loadAnnotation('face_f.png')">Face</a></li>
						<li><a href="javascript:loadAnnotation('face_r_f.png')">Right Face</a></li>
						<li><a href="javascript:loadAnnotation('face_l_f.png')">Left Face</a></li>
				</ul>
		</li>
		<li><a href="javascript:loadAnnotation('genitalia_f.png')">Genitalia </a></li>
		<li class="dropdown-submenu">
				<a class="test" tabindex="-1" href="#">Limb</a>
				<ul class="dropdown-menu">
						<li><a href="javascript:loadAnnotation('r_arm.png')">Right Arm</a></li>
						<li><a href="javascript:loadAnnotation('r_hand.png')">Right Hand</a></li>
						<li><a href="javascript:loadAnnotation('r_leg.png')">Right Leg</a></li>
		...
		<li class="dropdown-submenu">
				<a class="test" tabindex="-1" href="#">Mouth</a>
				<ul class="dropdown-menu">
						<li><a href="javascript:loadAnnotation('open_mouth_down.png')">Tongue Down</a></li>
						<li><a href="javascript:loadAnnotation('open_mouth_up.png')">Tongue Up</a></li>
				</ul>
		...
		<li class="dropdown-submenu">
				<a class="test" tabindex="-1" href="#">Neck</a>
				<ul class="dropdown-menu">
						<li><a href="javascript:loadAnnotation('neck_front.png')">Neck Front</a></li>
						<li><a href="javascript:loadAnnotation('r_neck_f.png')">Right Neck </a></li>
						<li><a href="javascript:loadAnnotation('l_neck_f.png')">Left Neck </a></li>
		...
		<li><a href="javascript:loadAnnotation('rectal_f.png')">Rectal </a></li>
		<li role="separator" class="divider"></li>
		<li class="dropdown-submenu">
				<a class="test" tabindex="-1" href="#">Baby</a>
				<ul class="dropdown-menu">
						<li><a href="javascript:loadAnnotation('baby_back.png')">Baby Back</a></li>
						<li><a href="javascript:loadAnnotation('baby_body_front_f.png')">Baby Back Front </a></li>
				</ul>
		...
		<li class="dropdown-submenu">
				<a class="test" tabindex="-1" href="#">Child</a>
				<ul class="dropdown-menu">
						<li><a href="javascript:loadAnnotation('child_abdomen_f.png')">Child Abdomen </a></li>
						<li><a href="javascript:loadAnnotation('child_back.png')">Child Back</a></li>
						<li><a href="javascript:loadAnnotation('child_body_front_f.png')">Child Body Front </a></li>
