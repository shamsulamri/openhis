	...
	<div class="form-group">
		<button class='btn btn-primary' onclick="loadAnnotation('genitalia_m.png')">Genital</button>
	</div>
	...
	<div class="form-group">
		<button class='btn btn-primary' onclick="loadAnnotation('rectal_m.png')">Rectal</button>
	</div>
