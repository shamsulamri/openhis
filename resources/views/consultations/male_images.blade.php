	...
	<div class="form-group">
		<button class='btn btn-default' onclick="loadAnnotation('genitalia_m.png')">Genital</button>
	</div>
	...
	<div class="form-group">
		<button class='btn btn-default' onclick="loadAnnotation('rectal_m.png')">Rectal</button>
	</div>
