...
<form action='/inventory_movement/search_item' method='post'>
	<div class='input-group'>
		<input type='text' class='form-control' placeholder="Find items" name='search' value='{{ isset($search) ? $search : '' }}' autocomplete='off' autofocus>
...
@endif
			...
			@endif
<br>
{{ $inventories->appends(['search'=>$search, 'reason'=>$reason])->render() }}
<br>
@if ($inventories->total()>0)
