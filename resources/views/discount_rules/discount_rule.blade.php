    ...
    <div class='form-group  @if ($errors->has('sponsor_code')) has-error @endif'>
        {{ Form::label('sponsor_code', 'sponsor_code',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('parent_code')) has-error @endif'>
        {{ Form::label('parent_code', 'parent_code',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('discount_amount')) has-error @endif'>
        <label for='discount_amount' class='col-sm-2 control-label'>discount_amount<span style='color:red;'> *</span></label>
        <div class='col-sm-10'>
