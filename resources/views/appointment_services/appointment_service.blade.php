    ...
    <div class='form-group  @if ($errors->has('service_name')) has-error @endif'>
        {{ Form::label('service_name', 'service_name',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('department_code')) has-error @endif'>
        <label for='department_code' class='col-sm-3 control-label'>department_code<span style='color:red;'> *</span></label>
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('service_start')) has-error @endif'>
        <label for='service_start' class='col-sm-3 control-label'>service_start<span style='color:red;'> *</span></label>
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('service_end')) has-error @endif'>
        <label for='service_end' class='col-sm-3 control-label'>service_end<span style='color:red;'> *</span></label>
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('service_duration')) has-error @endif'>
        {{ Form::label('service_duration', 'service_duration',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('service_monday')) has-error @endif'>
        {{ Form::label('service_monday', 'service_monday',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('service_tuesday')) has-error @endif'>
        {{ Form::label('service_tuesday', 'service_tuesday',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('service_wednesday')) has-error @endif'>
        {{ Form::label('service_wednesday', 'service_wednesday',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('service_thursday')) has-error @endif'>
        {{ Form::label('service_thursday', 'service_thursday',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('service_friday')) has-error @endif'>
        {{ Form::label('service_friday', 'service_friday',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('service_saturday')) has-error @endif'>
        {{ Form::label('service_saturday', 'service_saturday',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('service_sunday')) has-error @endif'>
        {{ Form::label('service_sunday', 'service_sunday',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('service_block_dates')) has-error @endif'>
        {{ Form::label('service_block_dates', 'service_block_dates',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('service_status')) has-error @endif'>
        <label for='service_status' class='col-sm-3 control-label'>service_status<span style='color:red;'> *</span></label>
        <div class='col-sm-9'>
