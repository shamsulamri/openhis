    ...
    <div class='form-group  @if ($errors->has('employer_name')) has-error @endif'>
        <label for='employer_name' class='col-sm-3 control-label'>employer_name<span style='color:red;'> *</span></label>
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('employer_street_1')) has-error @endif'>
        {{ Form::label('employer_street_1', 'employer_street_1',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('employer_street_2')) has-error @endif'>
        {{ Form::label('employer_street_2', 'employer_street_2',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('employer_city')) has-error @endif'>
        {{ Form::label('employer_city', 'employer_city',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('employer_postcode')) has-error @endif'>
        {{ Form::label('employer_postcode', 'employer_postcode',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('employer_state')) has-error @endif'>
        {{ Form::label('employer_state', 'employer_state',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('employer_country')) has-error @endif'>
        {{ Form::label('employer_country', 'employer_country',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('employer_phone')) has-error @endif'>
        {{ Form::label('employer_phone', 'employer_phone',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
