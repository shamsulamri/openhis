    ...
    <div class='form-group  @if ($errors->has('diet_code')) has-error @endif'>
        <label for='diet_code' class='col-sm-3 control-label'>diet_code<span style='color:red;'> *</span></label>
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('texture_name')) has-error @endif'>
        <label for='texture_name' class='col-sm-3 control-label'>texture_name<span style='color:red;'> *</span></label>
        <div class='col-sm-9'>
