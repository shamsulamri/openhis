    ...
    <div class='form-group  @if ($errors->has('tax_rate')) has-error @endif'>
        <label for='tax_rate' class='col-sm-2 control-label'>tax_rate<span style='color:red;'> *</span></label>
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('bill_discount')) has-error @endif'>
        <label for='bill_discount' class='col-sm-2 control-label'>bill_discount<span style='color:red;'> *</span></label>
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('bill_quantity')) has-error @endif'>
        <label for='bill_quantity' class='col-sm-2 control-label'>bill_quantity<span style='color:red;'> *</span></label>
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('bill_unit_price')) has-error @endif'>
        <label for='bill_unit_price' class='col-sm-2 control-label'>bill_unit_price<span style='color:red;'> *</span></label>
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('bill_exempted')) has-error @endif'>
        <label for='bill_exempted' class='col-sm-2 control-label'>bill_exempted<span style='color:red;'> *</span></label>
        <div class='col-sm-10'>
