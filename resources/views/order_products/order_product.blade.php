    ...
    <div class='form-group  @if ($errors->has('product_name')) has-error @endif'>
        <label for='product_name' class='col-sm-2 control-label'>product_name<span style='color:red;'> *</span></label>
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('order_form')) has-error @endif'>
        <label for='order_form' class='col-sm-2 control-label'>order_form<span style='color:red;'> *</span></label>
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('product_upc')) has-error @endif'>
        {{ Form::label('product_upc', 'product_upc',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('product_sku')) has-error @endif'>
        {{ Form::label('product_sku', 'product_sku',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('product_active')) has-error @endif'>
        {{ Form::label('product_active', 'product_active',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('product_drop_shipment')) has-error @endif'>
        {{ Form::label('product_drop_shipment', 'product_drop_shipment',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('product_stocked')) has-error @endif'>
        {{ Form::label('product_stocked', 'product_stocked',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('product_purchased')) has-error @endif'>
        {{ Form::label('product_purchased', 'product_purchased',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('product_sold')) has-error @endif'>
        {{ Form::label('product_sold', 'product_sold',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('product_sale_price')) has-error @endif'>
        {{ Form::label('product_sale_price', 'product_sale_price',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('product_discontinued')) has-error @endif'>
        {{ Form::label('product_discontinued', 'product_discontinued',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('product_guarantee_days')) has-error @endif'>
        {{ Form::label('product_guarantee_days', 'product_guarantee_days',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('product_bom')) has-error @endif'>
        {{ Form::label('product_bom', 'product_bom',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('product_reorder')) has-error @endif'>
        {{ Form::label('product_reorder', 'product_reorder',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('product_purchase_price')) has-error @endif'>
        {{ Form::label('product_purchase_price', 'product_purchase_price',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('form_code')) has-error @endif'>
        {{ Form::label('form_code', 'form_code',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('product_average_cost')) has-error @endif'>
        {{ Form::label('product_average_cost', 'product_average_cost',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('product_units')) has-error @endif'>
        {{ Form::label('product_units', 'product_units',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('product_sale_margin')) has-error @endif'>
        {{ Form::label('product_sale_margin', 'product_sale_margin',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('product_gst')) has-error @endif'>
        {{ Form::label('product_gst', 'product_gst',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
