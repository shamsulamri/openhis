    ...
    <div class='form-group  @if ($errors->has('product_unit_charge')) has-error @endif'>
        {{ Form::label('product_unit_charge', 'product_unit_charge',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('product_conversion_unit')) has-error @endif'>
        {{ Form::label('product_conversion_unit', 'product_conversion_unit',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('status_code')) has-error @endif'>
        {{ Form::label('status_code', 'status_code',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
