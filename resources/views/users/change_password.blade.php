...
<div class='rows'>
    <div class='form-group  @if ($errors->has('current_password')) has-error @endif'>
        <label for='pass' class='col-sm-3 control-label'>Current Password</label>
        <div class='col-sm-4'>
    ...
    <div class='form-group  @if ($errors->has('new_password')) has-error @endif'>
        <label for='pass' class='col-sm-3 control-label'>New Password</label>
        <div class='col-sm-4'>
    ...
    <div class='form-group  @if ($errors->has('verify_password')) has-error @endif'>
        <label for='pass' class='col-sm-3 control-label'>Verify Password</label>
        <div class='col-sm-4'>
