    ...
    <div class='form-group  @if ($errors->has('nation_name')) has-error @endif'>
        <label for='nation_name' class='col-sm-3 control-label'>nation_name<span style='color:red;'> *</span></label>
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('nation_nationality')) has-error @endif'>
        <label for='nation_nationality' class='col-sm-3 control-label'>nation_nationality<span style='color:red;'> *</span></label>
        <div class='col-sm-9'>
