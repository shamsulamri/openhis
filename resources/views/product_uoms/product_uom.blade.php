    ...
    <div class='form-group  @if ($errors->has('uom_cost')) has-error @endif'>
        ...
        <div class='col-sm-10'>
			...
			@else
					{{ Form::label('label', '-' , ['class'=>'form-control']) }}
			@endif
        </div>
    </div>
    ...
    <div class='form-group  @if ($errors->has('uom_price')) has-error @endif'>
        ...
        <div class='col-sm-10'>
			...
			@else
					{{ Form::label('label', $product_uom->uom_price , ['class'=>'form-control']) }}
			@endcan
        </div>
    </div>
    ...
    <div class='form-group  @if ($errors->has('uom_price_2')) has-error @endif'>
        ...
        <div class='col-sm-10'>
			...
			@else
					{{ Form::label('label', $product_uom->uom_price_2 , ['class'=>'form-control']) }}
			@endcan
        </div>
    </div>
