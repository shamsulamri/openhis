    ...
    <div class='form-group  @if ($errors->has('unit_name')) has-error @endif'>
        <label for='unit_name' class='col-sm-3 control-label'>unit_name<span style='color:red;'> *</span></label>
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('unit_shortname')) has-error @endif'>
        {{ Form::label('unit_shortname', 'unit_shortname',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('unit_is_decimal')) has-error @endif'>
        {{ Form::label('unit_is_decimal', 'unit_is_decimal',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
    ...
    <div class='form-group  @if ($errors->has('unit_drug')) has-error @endif'>
        {{ Form::label('unit_drug', 'unit_drug',['class'=>'col-sm-3 control-label']) }}
        <div class='col-sm-9'>
