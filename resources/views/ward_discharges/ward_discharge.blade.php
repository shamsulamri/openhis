    ...
    <div class='form-group  @if ($errors->has('discharge_description')) has-error @endif'>
        {{ Form::label('discharge_description', 'discharge_description',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
            {{ Form::textarea('discharge_description', null, ['class'=>'form-control','placeholder'=>'','maxlength'=>'65535']) }}
