    ...
    <div class='form-group  @if ($errors->has('patient_new_ic')) has-error @endif'>
        {{ Form::label('patient_new_ic', 'New IC',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('patient_phone_home')) has-error @endif'>
        {{ Form::label('patient_phone_home', 'Phone Home',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('patient_phone_mobile')) has-error @endif'>
        {{ Form::label('patient_phone_mobile', 'Phone Mobile',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
    ...
    <div class='form-group  @if ($errors->has('patient_phone_office')) has-error @endif'>
        {{ Form::label('patient_phone_office', 'Phone Office',['class'=>'col-sm-2 control-label']) }}
        <div class='col-sm-10'>
