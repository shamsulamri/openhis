...
class DischargeController extends Controller
{
	...
	public function index()
	{
			...
			**/
			...
			//$discharges = DB::table('discharges as a')
			$discharges = Discharge::select('patient_mrn', 'b.encounter_code','patient_name', 'discharges.encounter_id', 'discharges.discharge_id', 'type_name','discharges.created_at', 'name','ward_name','mc_id', 'encounter_description', 'discharges.created_at as discharge_date', 'mc_time_start', 'mc_start', 'newborn_id')
					...
					->leftJoin('enc_newborns as k', 'k.encounter_id', '=', 'b.encounter_id')
