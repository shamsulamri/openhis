...
class DischargeController extends Controller
{
	...
	public function index()
	{
			...
			**/
			...
			$discharges = DB::table('discharges as a')
					->select('patient_mrn', 'b.encounter_code','patient_name', 'a.encounter_id', 'a.discharge_id', 'type_name','a.created_at', 'name','ward_name','mc_id', 'encounter_description')
					->leftJoin('encounters as b', 'b.encounter_id','=','a.encounter_id')
					->leftJoin('patients as c', 'c.patient_id','=','b.patient_id')
					->leftJoin('ref_discharge_types as d', 'd.type_code','=','a.type_code')
					->leftJoin('admissions as i', 'i.encounter_id', '=', 'b.encounter_id')
	...
	public function search(Request $request)
	{
			...
			$discharges = DB::table('discharges as a')
					->select('patient_mrn', 'patient_name', 'a.encounter_id', 'a.discharge_id', 'type_name','a.created_at', 'e.id','name','ward_name', 'b.encounter_code', 'mc_id', 'encounter_description')
					->leftJoin('encounters as b', 'b.encounter_id','=','a.encounter_id')
					->leftJoin('patients as c', 'c.patient_id','=','b.patient_id')
					->leftJoin('ref_discharge_types as d', 'd.type_code','=','a.type_code')
					->leftJoin('bills as e', 'e.encounter_id', '=', 'a.encounter_id')
